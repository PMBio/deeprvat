...
rule config:
    ...
    params:
        ...
        seed_genes_out = lambda wildcards: f'--seed-genes-out {wildcards.phenotype}/deeprvat/seed_genes.parquet' if wildcards.phenotype in training_phenotypes else ' ',
        baseline_out = lambda wildcards: f'--baseline-results-out  {wildcards.phenotype}/deeprvat/baseline_results.parquet' if wildcards.phenotype in training_phenotypes else ' ',
    shell:
        (
